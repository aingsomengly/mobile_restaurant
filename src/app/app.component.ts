...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Asain Square',  component: AsiansPage,  icon:'md-albums' },
      { title: 'Little Khmer', component: LittlekhPage, icon:'md-albums' },
      { title: 'Jaya', component: JayaPage, icon:'md-albums' },
